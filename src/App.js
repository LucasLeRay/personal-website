    ...
    <div className="App">
      <div className="Left">
        ...
        <div className="Description">
          <p>I am an <b>A.I. engineer</b>, specializing in its application to psychometrics and sociology. I deploy A.I. systems that turn complex human patterns into actionable insights.</p>
